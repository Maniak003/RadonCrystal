...
#define EEPROM_BLOCK_CRC_STRUCT (EEPROM_BLOCK_CRC_PUMP + 1) //ячейка контрольной суммы структур данных
#else
#define EEPROM_BLOCK_CRC_MAIN (EEPROM_BLOCK_SETTINGS_BOOK + sizeof(bookSettings)) //ячейка контрольной суммы основных настроек
#define EEPROM_BLOCK_CRC_BOOK (EEPROM_BLOCK_CRC_MAIN + 1) //ячейка контрольной суммы настроек журнала
#define EEPROM_BLOCK_CRC_STRUCT (EEPROM_BLOCK_CRC_BOOK + 1) //ячейка контрольной суммы структур данных
#endif
