...
//Тип дисплея
#define SSD1306 //выбор типа поключенного дисплея (доступны - PCD8544(NOKIA5110), SSD1306(OLED128x64), SH1106(OLED132x64) и CH1116(OLED128x64))


//Передача данных
#define USE_UART       0     //использовать UART для передачи данных (0 - выключить вывод данных | 1 - включить вывод данных)
#define UART_BAUND     115200 //скорость UART для передачи данных (9600 | 19200 | 38400 | 57600 | 74880 | 115200)
...
#define DEFAULT_GEIGER_TIME 1.0 //время измерения (для СБМ-20 - 36 секунд)(2.0..99.9, 100..150)(s)


//Настройки периферии
#define DISP_SCALE_IMG      1 //увеличить масштаб изображения дисплея(только для SSD1306 и SH1106) (0 - стандартный масштаб 84x48 | 1 - увеличенный масштаб 126x60)
...
#define GEIGER_OWN_BACK     1 //учет собственного фона счетчика (1 - собственный фон счетчика учитывается | 0 - собственный фон счетчика не учитывается)
...
#define MIN_GEIGER_TIME   0.1    //минимальное время счета (0.1..10)(s)
#define MAX_GEIGER_TIME   150    //максимальное время счета (10..500)(s)

#define OWN_BACK          5.0   //собственный фон счетчика(0.2имп/с для СБМ-20)(0.1..1)(imp/s)
#define DEAD_TIME         0.001  //мертвое время счетчика(200мкрС для СБМ-20)(0.0001..0.0002)(us/1000000)
#define COUNT_RATE        500    //минимальная скорость счета для начала корректировки мертвого времени(50..500)(imp/s)
...
#define DEFAULT_CONTRAST       50  //контрастность дисплея PCD8544 (0..127) или яркость дисплея SSD1306 (50..250)(шаг 10)
...
#define DEFAULT_SIGMA_LVL      3   //уровень сигмы (0 - 1 сигма | 1 - 2 сигмы | 2 - 3 сигмы)
